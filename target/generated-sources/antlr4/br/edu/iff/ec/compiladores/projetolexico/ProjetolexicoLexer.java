...
public class ProjetolexicoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"CRIAR_FICHA", "CLASSE", "LVL", "RACA", "NOME", "IMAGEM", "DESC", "RACAS", 
			"CLASSES", "WS", "DELIMITADOR", "NOME_USUARIO", "LEVEL", "ABRECHAV", 
	...
	public ProjetolexicoLexer(CharStream input) {
		super(input);
